      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">Home</a></li>
            <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">About Us</a></li>
            <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">Services</a></li>
        ...
        <div>
          ...
          <ul className="space-y-2">
             {/* Links with dark gray base color and even darker gray on hover */}
            <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">FAQ</a></li>
            ...
            <li><a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">Terms of Service</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4 mb-4">
            ...
            <a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300" aria-label="Facebook">
            ...
            <a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300" aria-label="Twitter">
               {/* Placeholder SVG for a social icon */}
               <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a href="#" className="text-gray-600 hover:text-gray-800 transition-colors duration-300" aria-label="LinkedIn">
               <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <p className="text-sm">Email: <a href="mailto:info@yourbrand.com" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">info@yourbrand.com</a></p>
          <p className="text-sm">Phone: <a href="tel:+1234567890" className="text-gray-600 hover:text-gray-800 transition-colors duration-300">+1 (234) 567-890</a></p>
        </div>
